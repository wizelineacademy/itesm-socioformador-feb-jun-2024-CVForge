...
const SvgComponent = ({ strokeColor = "#7E7E7E", ...props }: LiveIconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 72 72" id="linkedin">
    <g fill="none" fill-rule="evenodd"><g><rect width="72" height="72" fill="#117EB8" rx="4"></rect>
