        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col items-center px-20 py-2 pb-6">
            <div className="flex w-full justify-center">
              <p className="font-koh_santepheap text-5xl p-1 text-primarygray py-3 pt-2">
                Create Account
              </p>
            </div>
            <div className="py-4">
            ...
            <button
              ...
              className="flex items-center m-4 justify-center bg-gradient-to-r from-aiblue to-gptgreen felx-row text-white text-md rounded-3xl p-2.5 px-16 w-auto delay-50 hover:scale-105 duration-200"
            >
              Create Account
            </button>
          </div>
