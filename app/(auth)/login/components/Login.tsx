        ...
        <div className="flex flex-col pb-8">
          ...
          <div className="flex flex-row justify-between p-2 py-4 mx-8">
            ...
            <div className="flex flex-col items-center justify-center px-10">
              ...
              <p className="text-primarygray font-semibold font-inter text-xl p-4">
            ...
            {/* Right */}
            <div className="flex flex-col items-center justify-center px-10">
              <p className="font-koh_santepheap text-5xl p-1 text-primarygray pb-7 pt-2">
                Login
              </p>
              ...
              <div className="flex w-full justify-end py-1">
                <p className="flex text-xs text-gptgreen font-inter font-bold underline">
                  Forgot Password?
                </p>
              </div>
              <div className="p-4" />
