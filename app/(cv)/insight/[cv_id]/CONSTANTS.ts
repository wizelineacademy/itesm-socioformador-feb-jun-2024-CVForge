...
export const RECOMMENDATIONS = [
    {
        ...
        mainContent: "Get an IBM Data Analytics certification to improve your credibility.",
    },
    {
        title: "Learn React for Web Development",
        mainContent: "Enhance your web development skills by learning React, a popular JavaScript library for building user interfaces."
    },
    {
...
export const FETCHED_RECOMMENDATIONS = [
    {
        ...
        cv_id: "123",
        title: "Get IBM Data Analytics certification",
        main_content: "Get an IBM Data Analytics certification to improve your credibility.",
        completed: true
    },
    {
        recommendation_id: "1",
        cv_id: "123",
        title: "Learn React for Web Development",
        main_content: "Enhance your web development skills by learning React, a popular JavaScript library for building user interfaces.",
        completed: false
    },
    {
        recommendation_id: "2",
