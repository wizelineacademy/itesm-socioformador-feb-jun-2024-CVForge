...
def generate_cv(cv_data, job_position):
    try:
        ...
        prompt += (
            ...
            "You must return it in markdown format and include all possible content that fits the job position, like the following: <h2>Section</h2>, <h3>Content</h3>, <h3>Content</h3>"
